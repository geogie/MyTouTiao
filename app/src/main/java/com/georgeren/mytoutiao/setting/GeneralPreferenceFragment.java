package com.georgeren.mytoutiao.setting;
...
import com.georgeren.mytoutiao.utils.CacheDataManager;
import com.georgeren.mytoutiao.utils.SettingUtil;
import com.georgeren.mytoutiao.widget.IconPreference;
 ...
 * 设置的View：版本、更新日志、主要开发者、开源许可、源代码、版本声明
 */
...
public class GeneralPreferenceFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.pref_general);// 布局：版本、更新日志、主要开发者、开源许可、源代码、版本声明
