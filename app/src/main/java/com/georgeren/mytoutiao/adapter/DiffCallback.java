package com.georgeren.mytoutiao.adapter;
...
import com.georgeren.mytoutiao.bean.media.MediaWendaBean;
...
import com.georgeren.mytoutiao.bean.search.SearchResultBean;
...
public class DiffCallback extends DiffUtil.Callback {
    ...
    public static void notifyDataSetChanged(List oldList, List newList, int type, RecyclerView.Adapter adapter) {
        ...
        result.dispatchUpdatesTo(adapter);// 需要解决这个：Cannot call this method while RecyclerView is computing a layout or scrolling
    }
