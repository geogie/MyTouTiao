...
import com.georgeren.mytoutiao.module.wenda.content.WendaContentActivity;
...
public class WendaArticleTextViewBinder extends ItemViewBinder<WendaArticleDataBean,
        WendaArticleTextViewBinder.ViewHolder> {
    @NonNull
    @Override
